...
parser.add_argument('-s', '--schedule', type=str, default=None, dest='schedule', required=False,
                    help='-s change what schedule to use (n = normal schedule, f = flex schedule, c = custom schedule, w = weekend')
